...
require (
	github.com/SumoLogic/terraform-provider-sumologic v0.0.0-20211202004335-3bc20f2c9d18 // indirect
	...
	github.com/saurabh-agarwals/sumologic-api-client-go v0.0.0-20211202112918-ce8a38e51bfc // indirect
)
